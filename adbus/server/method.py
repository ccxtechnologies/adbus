...
class Method:
    ...
    def __init__(self, name, callback, depreciated=False, hidden=False,
            unprivleged=False, camel_convert=True):
        ...
        self.sdbus = sdbus.Method(self.name, self.callback, arg_signature,
                return_signature, depreciated, hidden, unprivleged)
        """Interface to sd-bus library"""

    def __call__(self, *args, **kwargs):
        return self.callback(*args, **kwargs)

def method(name=None, deprectiated=False, hidden=False,
        unprivleged=False, camel_convert=True):
    ...
    def wrapper():
        if not name:
            name = func.__name__
        return  Method(name, func, deprectiated, hidden, unprivleged, camel_convert)
    return wrapper
